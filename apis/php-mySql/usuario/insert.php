...
isset($data->Celular) ) {
    ...
    if(!empty($data->Nombre) && !empty($data->Apellido) &&
     ...
     !empty($data->Celular) ) {
        ...
        $insert_query = "INSERT INTO `usuario`(`Nombre`, `Apellido`, `Documento`, `FechaNacimiento`, `CiudadResidencia`, `Barrio`, `Celular`) 
        VALUES(:Nombre,:Apellido,:Documento,:FechaNacimiento,:CiudadResidencia,:Barrio,:Celular)";
