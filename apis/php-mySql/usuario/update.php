...
if(isset($data->Documento)){
    ...
    if($get_stmt->rowCount() > 0){
        ...
        $post_Nombre = isset($data->medico) ? $data->medico : $row['medico'];
        
        $update_query = "UPDATE `usuario` 
        SET Documento = :Documento, Nombre = :Nombre, Apellido = :Apellido, FechaNacimiento = :FechaNacimiento, CiudadResidencia = :CiudadResidencia, Barrio = :Barrio, Celular = :Celular,Hora = :Hora,DiaCita = :DiaCita,medico =:medico
        ...
        $update_stmt->bindValue(':medico', htmlspecialchars(strip_tags($post_Nombre)),PDO::PARAM_STR);
